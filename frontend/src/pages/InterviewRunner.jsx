    ...
    <div className="max-w-7xl mx-auto px-4 py-8 pb-32">
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center animate-fade-in">
          <div className="bg-white/90 backdrop-blur-md rounded-[2.5rem] p-8 max-w-md w-full mx-4 shadow-2xl border border-slate-200/50 transform transition-all duration-300 scale-100 animate-scale-in">
            ...
            <h3 className="text-xl font-black text-slate-800 text-center uppercase tracking-tight">Finish Interview</h3>
            <p className="text-slate-500 text-sm text-center mt-2 mb-6">
              Are you sure you want to end the session early? You will receive scores and feedback for the questions you've submitted so far.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="flex-1 py-3 px-4 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-sm shadow-md shadow-rose-200 hover:shadow-lg transition-all"
              >
                Yes, Finish
              </button>
            </div>
